...
from app.core.exceptions import ProviderError, ModelNotFoundError
...
class LMManager:
    ...
    @classmethod
    def test_connection(cls, provider: str = "ollama", model_name: str = None, api_key: Optional[str] = None) -> bool:
        """
